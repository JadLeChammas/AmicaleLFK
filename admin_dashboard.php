...
try {
    $stats['total_users'] = (int) $conn->query("SELECT COUNT(*) FROM membres")->fetchColumn();
    $stats['pending_users'] = (int) $conn->query("SELECT COUNT(*) FROM membres WHERE is_approved = 0")->fetchColumn();
    $stats['pending_posts'] = (int) $conn->query("SELECT COUNT(*) FROM publications WHERE status = 'pending'")->fetchColumn();
    $stats['upcoming_events'] = (int) $conn->query("SELECT COUNT(*) FROM evenements WHERE date_evenement >= CURDATE()")->fetchColumn();
    ...
    <div class="admin-dashboard">
        ...
        <section class="admin-hero">
            <div>
                ...
                <p class="admin-hero__subtitle">Centralisez vos actions clés pour piloter la plateforme et accompagner la communauté.</p>
            </div>
        </section>
        ...
        <main class="admin-panels" aria-label="Actions d'administration">
            ...
            <article class="admin-panel">
                <div class="panel-header">
                    ...
                    <div>
                        <h2>Événements</h2>
                        <p>Animez la communauté en planifiant ou en mettant à jour les événements.</p>
                    </div>
                </div>
                <div class="panel-actions">
            ...
            <article class="admin-panel">
                <div class="panel-header">
                    ...
                    <div>
                        <h2>Utilisateurs</h2>
                        <p>Suivez les nouveaux inscrits, attribuez des rôles et maintenez les comptes à jour.</p>
                    </div>
                </div>
                <div class="panel-actions">
